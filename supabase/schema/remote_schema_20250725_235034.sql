...
CREATE UNIQUE INDEX "idx_weekly_movement_plans_profile_week" ON "public"."weekly_movement_plans" USING "btree" ("profile_id", "week_start_date");
...
CREATE POLICY "Friends can see each other's moai memberships" ON "public"."moai_members" FOR SELECT USING ((EXISTS ( SELECT 1
   FROM "public"."friendships" "f"
  WHERE ((("f"."user_id" = "auth"."uid"()) AND ("f"."friend_id" = "moai_members"."profile_id")) OR (("f"."friend_id" = "auth"."uid"()) AND ("f"."user_id" = "moai_members"."profile_id"))))));
...
CREATE POLICY "Moai members can see other members in same moai" ON "public"."moai_members" FOR SELECT USING ("public"."is_user_member_of_moai"("auth"."uid"(), "moai_id"));
...
CREATE POLICY "Users can update moai memberships" ON "public"."moai_members" FOR UPDATE USING ((("profile_id" = "auth"."uid"()) OR ("moai_id" IN ( SELECT "m"."id"
   FROM "public"."moais" "m"
  WHERE ("m"."creator_id" = "auth"."uid"()))) OR ("public"."is_user_member_of_moai"("auth"."uid"(), "moai_id") AND (EXISTS ( SELECT 1
   FROM "public"."moai_members" "admin_mm"
  WHERE (("admin_mm"."moai_id" = "moai_members"."moai_id") AND ("admin_mm"."profile_id" = "auth"."uid"()) AND ("admin_mm"."role_in_moai" = 'admin'::"text") AND ("admin_mm"."is_active" = true))))))) WITH CHECK ((("profile_id" = "auth"."uid"()) OR ("moai_id" IN ( SELECT "m"."id"
   FROM "public"."moais" "m"
  WHERE ("m"."creator_id" = "auth"."uid"()))) OR ("public"."is_user_member_of_moai"("auth"."uid"(), "moai_id") AND (EXISTS ( SELECT 1
   FROM "public"."moai_members" "admin_mm"
...
CREATE POLICY "Users can view their own moai memberships" ON "public"."moai_members" FOR SELECT USING (("profile_id" = "auth"."uid"()));
...
CREATE POLICY "View moai members in shared moais" ON "public"."moai_members" FOR SELECT USING ("public"."is_user_member_of_moai"("auth"."uid"(), "moai_id"));
